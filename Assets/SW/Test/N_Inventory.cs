...
public class N_Inventory : MonoBehaviour
{
    ...
    private bool AddInventoryData(IItem item) => inventoryData.collection.Any(x => x.InventoryIndexNumber == item.InventoryIndexNumber);
    //--새로 생성된 아이템이 인벤토리 인덱스 번호랑 종복값이 있는지 확인 
